...
아이콘·스티커 편집에서 이미지를 추가하면 96 × 96px 규격의 사용자 샘플로 변환됩니다. GitHub 연결 상태에서는 `icon-sample-01.webp`, `sticker-sample-01.webp` 형식으로 자동 업로드됩니다.

메뉴 3번 이후 상품은 제품명과 가격 사이에 정보 문구를 추가할 수 있습니다. 문구의 크기·굵기·색상은 상품 편집과 글자 탭에서 조정하고, 전체 줄 간격은 **글자 → 전체 글자 줄 간격**에서 변경합니다.
